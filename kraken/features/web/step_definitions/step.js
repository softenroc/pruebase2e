...
When(
  "I fill on element having id {string} with text {string}",
  async function (element_id, data_to_fill) {
...
HEAD;
When(
  "I fill on element having css_element {string} with text {string}",
  async function (element_id, data_to_fill) {
    let element = await this.driver.$(element_id);
...
When(
  "I fill on field having css selector {string} with text {string}",
  async function (css_selector, data_to_fill) {
    let element = await this.driver.$(css_selector);
    return await element.setValue(data_to_fill);
  }
);
...
Then(
  "Validate value text css element {string} contain to {string}",
  async function (element_id, data_to_compare) {
    let element = await this.driver.$(element_id);
...
Then(
  "Validate text main error to login equals to {string}",
...
Then(
  "Validate text main author response equals to {string}",
  async function (string) {
    let element = await this.driver.$(
...
Then(
  "Validate text main owner response equals to {string}",
  async function (string) {
    let element = await this.driver.$(
...
Then(
  "Validate text main new tag response equals to {string}",
  async function (string) {
    let element = await this.driver.$(
...
Then(
  "Validate value text having id {string} equals to {string}",
  async function (element_id, data_to_compare) {
    let element = await this.driver.$(element_id);
...
Then(
  "Validate value text having css_element {string} equals to {string}",
  async function (element_id, data_to_compare) {
    let element = await this.driver.$(element_id);
    let p_text = await element.getValue();
    expect(p_text).to.contain(data_to_compare);
